...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		final var cookieCsrfTokenRepository = CookieCsrfTokenRepository.withHttpOnlyFalse();
		final var csrfTokenRequestAttributeHandler = new CsrfTokenRequestAttributeHandler();
	...
	private AuthenticationEntryPoint authenticationEntryPoint() {
		...
		final var delegatingAuthenticationEntryPoint = new DelegatingAuthenticationEntryPoint(entryPoints);
